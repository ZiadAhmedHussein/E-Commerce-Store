  ...
  return (
    ...
    >
      <div className=" container">
        <h2 className=" text-white pt-5">Get The Fresh Cart App</h2>
        <p className="lead">
        ...
        <div className=" row postars px-2 text-white  d-flex justify-content-between align-items-center  py-4 border-bottom">
          <div className="partners col-6 justify-content-between gap-3 align-items-center d-flex">
          ...
          <div className="FreshCart col-6 align-items-center d-flex row ">
            <p className="m-0 col-6">Get deliveries with FreshCart</p>
            <ul className="d-flex col-6 align-items-center list-unstyled gap-3 m-0">
              <li>
                <img
                  src={appStoreImg}
                  height={30}
